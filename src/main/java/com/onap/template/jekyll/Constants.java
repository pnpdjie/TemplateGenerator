...
public class Constants {
   ...
   * Jekyll项目配置文件名称.
   */
  public static final String JEKYLL_CONFIG_FILE = "_config.yml";

  /**
   * Jekyll项目菜单配置参数名称.
   */
  public static final String JEKYLL_CONFIG_TOCS = "tocs:";

  /**
   * Jekyll项目菜单配置参数每项前缀.
   */
  public static final String JEKYLL_CONFIG_TOCS_PRE = "  - ";
